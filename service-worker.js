/* MOAQIB — FINAL SERVICE WORKER
   ...
   ------------------------------------------------------------------ */
const CACHE_VERSION = 'moaqib-v7-foundation-01';
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const RUNTIME_CACHE = `${CACHE_VERSION}-runtime`;
const APP_SHELL = [
  './index.html', './ui-foundation.css', './productivity.css', './ui-rebuild.css', './v7-motion.css', './push-config.js', './productivity.js', './v7-runtime.js', './app.js', './manifest.webmanifest',
